...
int main(int argc, char** argv) {
    ...
    if (myid == 0) {
        std::cout << "===========================================\n";
        std::cout << "HYPRE GPU Native Poisson Solver Benchmark (V2)\n";
        std::cout << "(CPU matrix gen + GPU solve - Stable version)\n";
        std::cout << "===========================================\n\n";
    ...
    if (myid == 0) {
        config_reader.print_summary("HYPRE-GPU-Native-V2");
    }
    ...
    for (int grid_size : grid_sizes) {
        ...
        if (myid == 0) {
            ...
            result.library_name = "HYPRE-GPU-Native-V2";
            result.test_name = "Poisson_2D_PCG_" + precond_type + "_GPUNative_V2";
    ...
    if (myid == 0) {
        ...
        writer.write_csv("hypre_gpu_native_v2_results.csv");
        writer.write_json("hypre_gpu_native_v2_results.json");
